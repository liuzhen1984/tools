...
public class RetwisRepository {
    ...
    HashMapper<Post, String, String>  nm = (HashMapper<Post, String, String>)new JacksonHashMapper<Post>(Post.class);
	private final HashMapper<Post, String, String> postMapper = new DecoratingStringHashMapper<Post>(nm);
